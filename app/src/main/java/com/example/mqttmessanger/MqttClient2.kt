...
const val SOLACE_MQTT_HOST = "tcp://broker.emqx.io:1883"

// Other options
const val SOLACE_CONNECTION_TIMEOUT = 30
...
class MqttClient2(context: Context?) {
    ...
    private fun connect() {
     ...
     //   mqttConnectOptions.mqttVersion=4
        ...
        try {
            ...
            mqttAndroidClient.connect(mqttConnectOptions, null, object : IMqttActionListener {
                override fun onSuccess(asyncActionToken: IMqttToken) {
                    ...
                    Log.i(TAG, "Success to connect to: $serverUri")
